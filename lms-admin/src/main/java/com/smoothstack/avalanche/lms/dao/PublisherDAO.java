...
public class PublisherDAO extends BaseDAO<Publisher> implements ResultSetExtractor<List<Publisher>>
{
	...
	public void deletePublisher(int pubId) throws SQLException, ClassNotFoundException
	{
		mySqlTemplate.update( "DELETE FROM tbl_publisher WHERE publisherId = ?", new Object[] {pubId});
	}

...
public class BookLoans {
	...
	// May need to remove columnDefinition for other db typs (mysql, oracle, etc...)
	@Column(name ="dateOut", columnDefinition="datetime (Types#TIMESTAMP)")
	private Date dateOut;

	// May need to remove columnDefinition for other db typs (mysql, oracle, etc...)
	@Column(name ="dueDate", columnDefinition="datetime (Types#TIMESTAMP)")
	private Date dueDate;

	// May need to remove columnDefinition for other db typs (mysql, oracle, etc...)
	@Column(name = "dateIn", columnDefinition="datetime (Types#TIMESTAMP)")
	private Date dateIn;
